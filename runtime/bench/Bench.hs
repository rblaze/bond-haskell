...
main = defaultMain
    ...
    , bgroup "VarInt"
        [ bgroup "Read"
            [ intRead "1" $ take 100000 $ cycle [0 .. 127]
            , intRead "2" $ take 100000 $ cycle [128 .. 16383]
            , intRead "3" $ take 100000 $ cycle [16384 .. 2097151]
            , intRead "4" $ take 100000 $ cycle [2097152 .. 268435455]
            , intRead "5" $ take 100000 $ cycle [268435456 .. 34359738367]
            , intRead "6" $ take 100000 $ cycle [34359738368 .. 4398046511103]
            , intRead "7" $ take 100000 $ cycle [4398046511104 .. 562949953421311]
            , intRead "8" $ take 100000 $ cycle [562949953421312 .. 72057594037927935]
            , intRead "9" $ take 100000 $ cycle [72057594037927936 .. 9223372036854775807]
            , intRead "10" $ take 100000 $ cycle [9223372036854775808 .. maxBound]
            ]
        , bgroup "Write"
            [ intWrite "1" $ take 100000 $ cycle [0 .. 127]
            , intWrite "2" $ take 100000 $ cycle [128 .. 16383]
            , intWrite "3" $ take 100000 $ cycle [16384 .. 2097151]
            , intWrite "4" $ take 100000 $ cycle [2097152 .. 268435455]
            , intWrite "5" $ take 100000 $ cycle [268435456 .. 34359738367]
            , intWrite "6" $ take 100000 $ cycle [34359738368 .. 4398046511103]
            , intWrite "7" $ take 100000 $ cycle [4398046511104 .. 562949953421311]
            , intWrite "8" $ take 100000 $ cycle [562949953421312 .. 72057594037927935]
            , intWrite "9" $ take 100000 $ cycle [72057594037927936 .. 9223372036854775807]
            , intWrite "10" $ take 100000 $ cycle [9223372036854775808 .. maxBound]
            ]
        ]
    ]
